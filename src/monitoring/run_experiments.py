...
if __name__ == "__main__":
    ...
    print(f"  Open HTML files in browser to see visual reports:\n")
    print(f"    open reports/drift/exp1_no_drift.html")
    print(f"    open reports/drift/exp2_data_drift_short_texts.html")
    print(f"    open reports/drift/exp3_prediction_drift.html")
    print(f"    open reports/drift/exp4_data_quality_drift.html")
    print(f"    open reports/drift/exp4_data_quality_report.html")
    print(f"    open reports/drift/exp5_week_1.html")
    print(f"    open reports/drift/exp5_week_2.html")
    print(f"    open reports/drift/exp5_week_3.html")
    print(f"    open reports/drift/exp5_week_4.html")
    print(f"    open reports/drift/exp5_week_5.html")
    print()
